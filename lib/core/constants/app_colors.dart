...
class AppColors {
  static Color primaryColor = Color(0xFF17B8A6);
  static Color transparentPrimaryColor = Color(0x8517B8A5);
  static Color accentColor = Color.fromARGB(255, 255, 193, 7);
  static Color transparentAccentColor = Color(0x84FFC107);
  static Color darkBlueColor = Color(0xFF448AFF);
  static Color transparentBlueColor = Color(0x844489FF);
  static Color darkPurpleColor = Color(0xFF673AB7);
...
class DarkColors {
  static Color primaryBackgroundColor = Color(0xFF1C1C1E);
  static Color accentBackgroundColor = Color(0xFF2C2C2E);
  static Color primaryTextColor = Color(0xFFFFFFFF);
  static Color accentTextColor = Color(0xFFB3B3B3);
  static Color hintTextColor = Color(0xFF8E8E93);
  static Color shimmerBaseColor = Color(0xFF2A2A2E);
  static Color shimmerHighlightColor = Color(0xFF3A3A3C);
  static Color shadowColor = Color(0x4D000000);
}
